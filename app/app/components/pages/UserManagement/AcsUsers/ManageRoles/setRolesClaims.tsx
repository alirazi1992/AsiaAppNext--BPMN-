...
import { GetBaseType, GetBaseValueTypes, GetRolesClaimsModel, Response, RoleClaimsModel, SelectUsersRoles } from '@/app/models/UserManagement/Role';
...
const RolesClaims = (props: any) => {
    ...
    useEffect(() => {
        const GetUserRoles = async () => {
            ...
            let url = `${process.env.NEXT_PUBLIC_API_URL}/identity/manage/GetRoleClaims?roleId=${props.props}`;
            let method = 'get';
            let data = {}
